...
export const Hero = () => {
  ...
  return <div className="relative">
      ...
      <HeroGeometric badge="Global Water Solutions" title1="Engineering the Future of" title2="Water Treatment">
      {/* Subheadline */}
      <motion.div initial={{
        opacity: 0,
        y: 30
      ...
      <motion.div initial={{
        ...
        <Button size="lg" variant="outline" asChild className="border-2 border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground transition-all duration-300 text-base sm:text-lg px-8 sm:px-10 py-6 sm:py-7 rounded-2xl backdrop-blur-xl bg-background/10 w-full sm:w-auto">
