...
export const FloatingEmail = () => {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="fixed bottom-8 right-8 z-50 w-16 h-16 rounded-full bg-gradient-cyan shadow-2xl flex items-center justify-center cursor-pointer group hover:shadow-glow-lg transition-all duration-300"
      aria-label="Email us"
    >
      <motion.div
        animate={{
